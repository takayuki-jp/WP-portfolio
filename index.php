    ...
    <section id="js_topWorks" class="top-works">
      <div class="top-works__inner c-sectionPadding">
          ...
          <div class="splide__track">
            <ul class="splide__list">
              <li class="splide__slide top-works__cardItem c-worksCard">
                <a class="c-worksCard__link" href="#">
                  <div class="c-worksCard__image">
                    <img src="../img/worksItem_codejump.png" alt="codejumpのサムネイル">
                  </div>
                  <div class="c-worksCard__info">
                    <div class="c-worksCard__titleWrap">
                      <p class="c-worksCard__client">Code jump 様</p>
                      <p class="c-worksCard__title">家具店舗の仮想WEBサイト</p>
                    </div>
                    <div class="c-worksCard__category c-worksCard__category--website">WEBサイト</div>
                  </div>
                </a>
              </li>
              <li class="splide__slide top-works__cardItem c-worksCard">
                <a class="c-worksCard__link" href="#">
                  <div class="c-worksCard__image">
                    <img src="../img/worksItem_TETOTE.png" alt="codejumpのサムネイル">
                  </div>
                  <div class="c-worksCard__info">
                    <div class="c-worksCard__titleWrap">
                      <p class="c-worksCard__client">しょーごログ 様</p>
                      <p class="c-worksCard__title">TETOTE（企業採用サイト）</p>
                    </div>
                    <div class="c-worksCard__category c-worksCard__category--website">WEBサイト</div>
                  </div>
                </a>
              ...
              <li class="splide__slide top-works__cardItem c-worksCard">
                <a class="c-worksCard__link" href="#">
                  <div class="c-worksCard__image">
                    <img src="../img/worksItem_LP.png" alt="codejumpのサムネイル">
                  </div>
                  <div class="c-worksCard__info">
                    <div class="c-worksCard__titleWrap">
                      <p class="c-worksCard__client">検査技術ゼミ 様</p>
                      <p class="c-worksCard__title">オンライン家庭教師のLPサイト</p>
                    </div>
                    <div class="c-worksCard__category c-worksCard__category--LP">LP</div>
                  </div>
                </a>
              </li>
              <li class="splide__slide top-works__cardItem c-worksCard">
        ...
        <div class="top-works__btnWrap c-btnWrap">
          <a class="top-works__btnLink c-btn" href="./works.html">more</a>
        </div>
          ...
          <ul class="top-service__list">
            <li class="top-service__listItem animeTarget slideInLtoR">
              <div class="top-service__itemImage">
                <img src="../img/service-pc.png" alt="PCのイラスト">
              </div>
            ...
            <li class="top-service__listItem animeTarget slideInRtoL">
              <div class="top-service__itemImage">
                <img src="../img/service-sp.png" alt="スマートフォンのイラスト">
              </div>
              <div class="top-service__textArea">
            ...
            <li class="top-service__listItem animeTarget slideInLtoR">
              <div class="top-service__itemImage">
                <img src="../img/service-brush.png" alt="ブラシのイラスト">
              </div>
              <div class="top-service__textArea">
      ...
      <div class="top-about__inner  c-sectionPadding">
        ...
        <div class="top-about__contentWrap">
          <div class="top-about__image animeTarget slideInLtoR">
            <img src="../img/my-image.png" alt="わたしのアイコンの画像">
          </div>
        ...
        <div class="top-contact__inner c-sectionPadding">
          ...
          <div class="top-contact__contentWrap animeTarget">
            <div class="top-contact__image top-contact__image--sp animeTarget slideInLtoR">
              <img src="../img/top-contact__iphone.png" alt="iphoneのはめ込み画像">
            </div>
            ...
            <div class="top-contact__image top-contact__image--pc animeTarget slideInRtoL">
              <img src="../img/top-contact__macbook.png" alt="macbookのはめ込み画像">
            </div>
          </div>
